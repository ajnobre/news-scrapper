...
def process(news_scrapper, workitem,page ):
    ...
    extracted_news_table = news_scrapper.process_search_results(page, start_date, search_phrase)
    ...
    def process_search_results(self, page, start_date, search_phrase):
        ...
        while search_next_page:
            ...
            for item in list_items_locator: 
                ...
                if match:
                    title, extracted_date, count_search_phrase, contains_money_pattern = self.extract_info(text, search_phrase)
